...
const translations = {
  en: {
    ...
    job1_desc: "Managed daily office operations, provided administrative support to staff, and ensured a smooth workflow. Organized files, handled data entry, and maintained accurate records. Assisted with internal communications and customer inquiries, demonstrating adaptability in a Canadian professional environment.",
  ...
  ja: {
    ...
    job1_desc: "日常のオフィス運営およびスタッフへの事務サポートを統括し、円滑な業務フローの構築に貢献。書類管理、データ入力、正確な記録保持を徹底するとともに、社内コミュニケーションや顧客対応を円滑にサポートし、カナダのビジネス環境における高い適応力を証明しました。",
