...
const translations = {
  en: {
    ...
    job1_desc: "Managed daily office operations, provided administrative support to staff, and ensured a smooth workflow. Verified basic product information (e.g., product codes, specifications) and performed accurate data entry into the ERP system. Maintained organized records, and assisted with internal communications and customer inquiries, demonstrating adaptability in a Canadian professional environment.",
  ...
  fr: {
    ...
    job1_desc: "Gestion des opérations quotidiennes et soutien administratif afin de garantir la fluidité des processus internes. Vérification des informations de base sur les produits (ex: codes produits) et saisie précise des données dans le système ERP. Responsable de l'organisation des dossiers et de la tenue rigoureuse des registres. Coordination des communications internes et des demandes des clients, illustrant une grande capacité d'adaptation au sein du milieu professionnel canadien.",
  ...
  ja: {
    ...
    job1_desc: "日常のオフィス運営およびスタッフへの事務サポートを統括し、円滑な業務フローの構築に貢献。商品の基本情報（商品コードなど）の確認およびERPシステムへの正確なデータ入力業務を担当。書類管理、正確な記録保持を徹底するとともに、社内コミュニケーションおよび顧客対応を円滑にサポートし、カナダのビジネス環境における高い適応力を証明しました。",
    ...
    job4_date: "2015-2016 & 2017 – 2021年8月 (日本留学のため1年休職)",
    job4_title: "日本語教師 | さくら日本語センター - ホーチミン市",
    job4_desc: "初級者から上級者まで、幅広いレベルの学習者に対し日本語および日本文化を指導。体系的なレッスンプランの策定、独自の教材作成、および学習進捗の的確な評価を実施しました。学習者がそれぞれの語学目標を達成できるよう、対話重視でサポートの行き届いた魅力的な学習環境を提供しました。",
    edu_title: "学歴",
    edu_sub1: "学歴および資格",
    edu_1: "日本語能力試験 N1 認定",
