...
const translations = {
  en: {
    ...
    job1_desc: "Managed daily office operations, provided administrative support to staff, and ensured a smooth workflow. Verified basic product information (e.g., product codes, specifications) and performed accurate data entry into the ERP system. Maintained organized records and assisted with internal communications, demonstrating adaptability in a Canadian professional environment.",
  ...
  ja: {
    ...
    job1_desc: "日常のオフィス運営およびスタッフへの事務サポートを統括し、円滑な業務フローの構築に貢献。商品の基本情報（商品コードなど）の確認およびERPシステムへの正確なデータ入力業務を担当。書類管理、正確な記録保持を徹底するとともに、社内コミュニケーションを円滑にサポートし、カナダのビジネス環境における高い適応力を証明しました。",
